 ...
 */
class Placebid extends OperationBase {
    ...
    async submitTransaction() {
        const transferArgs = this.simpleState.getBidArguments();
        await this.sutAdapter.sendRequests(this.createConnectorRequest('placeBid', transferArgs));
    }
}
