 ...
 */
class Certifyprod extends OperationBase {
    ...
    async submitTransaction() {
        const transferArgs = this.simpleState.getCertifyArguments();
        await this.sutAdapter.sendRequests(this.createConnectorRequest('certifyprod', transferArgs));
    }
}
