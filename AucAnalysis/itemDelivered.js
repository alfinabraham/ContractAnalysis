 ...
 */
class Itemdelivered extends OperationBase {
    ...
    async submitTransaction() {
        const itemdelArgs = this.simpleState.getItemDeliverArguments();
        await this.sutAdapter.sendRequests(this.createConnectorRequest('itemDelivered', itemdelArgs));
    }
}
