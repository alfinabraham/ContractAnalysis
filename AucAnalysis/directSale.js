 ...
 */
class Directsale extends OperationBase {
    ...
    async submitTransaction() {
        const dsaleArgs = this.simpleState.getDsaleArguments();
        await this.sutAdapter.sendRequests(this.createConnectorRequest('directSale', dsaleArgs));
    }
}
