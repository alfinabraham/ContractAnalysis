...
class OperationBase extends WorkloadModuleBase {
    ...
    async initializeWorkloadModule(workerIndex, totalWorkers, roundIndex, roundArguments, sutAdapter, sutContext) {
        ...
        this.assertSetting('initialWeight');
        this.assertSetting('expDate');
        this.assertSetting('numberOfAccounts');

        this.initialWeight = this.roundArguments.initialWeight;
        this.expDate = this.roundArguments.expDate;
    ...
    _createFabricConnectorRequest(operation, args) {
        const query = operation === 'announceWinner';
        return {
            contractId: 'auctionsale',
            contractVersion: '1.0',
