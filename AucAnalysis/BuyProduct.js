 ...
 */
class Buyproduct extends OperationBase {
    ...
    async submitTransaction() {
        const buyArgs = this.simpleState.getBuyProductArguments();
        await this.sutAdapter.sendRequests(this.createConnectorRequest('BuyProduct', buyArgs));
    }
}
