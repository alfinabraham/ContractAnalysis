 ...
 */
class Startauction extends OperationBase {
    ...
    async submitTransaction() {
        const transferArgs = this.simpleState.getAuctionArguments();
        await this.sutAdapter.sendRequests(this.createConnectorRequest('startAuction', transferArgs));
    }
}
